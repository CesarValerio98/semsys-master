    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('/root/university/services') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="descripcion" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" id="descripcion" placeholder="Ingrese una descripción del servicio" rows="5" maxlength="255" autofocus required>{{ old('descripcion') }}</textarea>
