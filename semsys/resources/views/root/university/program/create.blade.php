...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Crear Programa') }}</div>

                <div class="card-body">
                    <form action="{{ url('/root/university/programs') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control{{ $errors->has('area') ? ' is-invalid' : '' }}" id="area" name="area" maxlength="45" value="{{ old('area') }}" placeholder="Ingrese un nombre" required autofocus>
                                @if ($errors->has('area'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control{{ $errors->has('enfoque') ? ' is-invalid' : '' }}" id="enfoque" name="enfoque" maxlength="45" value="{{ old('enfoque') }}" placeholder="Ingrese un nombre" required autofocus>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control{{ $errors->has('tipo') ? ' is-invalid' : '' }}" id="tipo" name="tipo" maxlength="45" value="{{ old('tipo') }}" placeholder="Ingrese un nombre" required autofocus>
                                @if ($errors->has('tipo'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control{{ $errors->has('grado') ? ' is-invalid' : '' }}" id="grado" name="grado" maxlength="45" value="{{ old('grado') }}" placeholder="Ingrese el grado" required autofocus>
                                @if ($errors->has('grado'))
                                    <span class="invalid-feedback" role="alert">
